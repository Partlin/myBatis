...
public class JsonUtil {
    ...
    public static void sendjson(String msg,HttpServletResponse response){
    ...
    public static StringBuffer StringTojson(String key,Object value){
    	StringBuffer data=new StringBuffer();
    	return data.append("\"").append(key).append("\":\"").append(value).append("\"");
    	
    }
    public static StringBuffer StringJsonTojson(String key,Object value){
    	StringBuffer data=new StringBuffer();
    	return data.append("\"").append(key).append("\":").append(value);
